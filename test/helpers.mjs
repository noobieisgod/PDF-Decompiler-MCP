...
export function rawDocument(pageCount = 2) {
    return {
        ...
        pages: Array.from({ length: pageCount }, (_, index) => ({
            ...
            textBlocks: [{ text: `Alpha page ${index + 1} revenue deterministic evidence`, role: 'text', bbox: { x: 72, y: 72, width: 260, height: 18 } }],
            images: [],
            tables: index === 0 ? [{ data: [['Quarter', 'Revenue'], ['Q1', '100']], bbox: { x: 72, y: 120, width: 260, height: 80 } }] : [],
            links: [],
            annotations: [],
            pageImage: null,
