...
|---|---|---|---|---|---|
| Official MCP TypeScript client | 2.0.0 | 2026-08-01 | Windows build 26200.8655, Node 24.14.1 | Automated | Discovery, schemas, structured content, errors, resources, inline images, cursors, partial work, and shutdown pass `npm test` |
...
| 2025-era raw stdio client | Protocol 2025-06-18 | 2026-08-01 | Windows build 26200.8655, Node 24.14.1 | Automated | Claim-less initialization and clean shutdown pass `test/server-smoke.test.mjs` |
